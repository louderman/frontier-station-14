...
public sealed class ContrabandSystem : EntitySystem
{
    ...
    private void OnDetailedExamine(EntityUid ent, ContrabandComponent component, ref GetVerbsEvent<ExamineVerb> args)
    {
        ...
        var examineMarkup = GetContrabandExamine(Loc.GetString(severity.ExamineText, ("type", ContrabandItemType.Item)), departmentExamineMessage, component.HideCarryStatus ? null : carryingMessage); // Frontier: add severity examine text, pass HideCarryStatus
